...
if __name__ == "__main__":
    ...
    #laod ancestors
    tax_infos = utils.loading_ancestors(path_ancestor_file) #return a list tax_infos[0] = dict <key = value, value = list of ancestors>, tax_infos[1] = set with all the values in taxonomy
